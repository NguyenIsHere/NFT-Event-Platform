// src/clients/eventServiceClient.js (trong 06-Blockchain-service)
...
if (!process.env.EVENT_SERVICE_ADDRESS) {
  console.warn(
    "WARNING for BlockchainService's EventClient: EVENT_SERVICE_ADDRESS is not defined in .env. Calls to Event service will likely use default 'localhost' and may fail in Docker."
  )
}
...
console.log(
  `BlockchainService: Event client attempting to connect to ${EVENT_SERVICE_ADDRESS} using proto: ${EVENT_PROTO_PATH}`
)
